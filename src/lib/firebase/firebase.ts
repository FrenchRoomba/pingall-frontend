...
export async function getAuthenticatedAppForUser(
  ...
  // if (sAuth.currentUser?.uid !== decodedIdToken.uid) {
  ...
  //   await signInWithCustomToken(sAuth, customToken);
  // }
  // console.log("server: ", app);
  // return { app, currentUser: sAuth.currentUser };
}
